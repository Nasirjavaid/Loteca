        ...
        create: (context) {
          return MainRoundBloc()
            ..add(GetMainRoundEvent(
                mainRoundCallDirection: 2, userId: validateUser.user.id));
        },
        ...
        child: IconButton(
            ...
            onPressed: () {
              BlocProvider.of<MainRoundBloc>(context).add(GetMainRoundEvent(
                  mainRoundCallDirection: 2,
                  userId: widget.validateUser.user.id));
            }));
  }
...
//checking user before placing the order
        ...
        : showReciptAndBetSubmittedButtons(mainRound, widget.validateUser);
  }

  Widget showReciptAndBetSubmittedButtons(
      MainRound mainRound, ValidateUser validateUser) {
...
//checking user before placing the order
                ...
                onPressed: () async {
                  Methods.showDialogueForUserBetDetail(
                      context, mainRound, validateUser);
