...
class UserValidationWithEmailFormWidgetMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return UserValidationWithEmailFormWidget();
  }
}

class UserValidationWithEmailFormWidget extends StatefulWidget {
  @override
  _UserValidationWithEmailFormWidgetState createState() =>
      _UserValidationWithEmailFormWidgetState();
}

class _UserValidationWithEmailFormWidgetState extends State<UserValidationWithEmailFormWidget> {
  String selectedDate;
  String selectedTime;
  ...
  _submitButtonPressed() {
    if (etEmail.text == null || etEmail.text.isEmpty) {
      ...
      BlocProvider.of<SendCoinBloc>(context).add(
        ValidateUserForBetEvent(email: etEmail.text),
      );
    }
  }
