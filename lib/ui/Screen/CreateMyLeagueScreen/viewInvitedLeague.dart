...
class ViewInvitedLeague extends StatefulWidget {
  @override
  _ViewInvitedLeagueState createState() => _ViewInvitedLeagueState();
}

class _ViewInvitedLeagueState extends State<ViewInvitedLeague> {
