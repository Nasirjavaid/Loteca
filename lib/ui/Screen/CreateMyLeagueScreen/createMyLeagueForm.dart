...
class CreateMyLeagueForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return CreateMyLeagueFormWidget();
  }
}

class CreateMyLeagueFormWidget extends StatefulWidget {
  @override
  _CreateMyLeagueFormWidgetState createState() =>
      _CreateMyLeagueFormWidgetState();
}

class _CreateMyLeagueFormWidgetState extends State<CreateMyLeagueFormWidget> {
  String selectedDate;
  String selectedTime;
  TextEditingController etleagueName = TextEditingController();
  ...
  _submitButtonPressed() {
    if (etleagueName.text == null || etleagueName.text.isEmpty) {
      _showToast(context, "Please enter League name");
    
    } else {
      BlocProvider.of<CreateMyLeagueBloc>(context).add(
        CreateNewMyLeagueEvent(myLeageName: etleagueName.text),
      );
    }
  }
      ...
      child: Card(
        child: Column(
          ...
          children: [
            ...
            enterLeagueNameInputField(context),
            SizedBox(
              height: 20,
            ),
  ...
  Widget enterLeagueNameInputField(BuildContext context) {
    return Container(
      width: MediaQuery.of(context).size.width * 0.8,
      height: MediaQuery.of(context).size.height * 0.06,
      child: new TextField(
          controller: etleagueName,
          expands: false,
          maxLines: 1,
          minLines: 1,
